...
class FetchMusicBrainzTests(unittest.TestCase):
    ...
    def test_valid_numeric_and_http_date_retry_after_recover(self):
        cases = (("4.5", 4.5), ("Wed, 17 Sep 2026 12:00:05 GMT", 5.0))
    ...
    def test_invalid_expired_zero_missing_and_excessive_retry_after_are_bounded(self):
