...
def serialize_page_summaries(records: Sequence[dict[str, Any]]) -> str:
    ...
    try:
        ...
        raise WikimediaError(
            "Wikimedia records could not be serialized as UTF-8"
        ) from exc
    return payload
...
def main(argv: Sequence[str] | None = None) -> None:
    ...
    try:
        ...
        payload = serialize_page_summaries(records)
