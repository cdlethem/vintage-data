...
MAILTO = os.environ.get("EXTRACT_CONTACT") or "you@example.com"  # <-- REQUIRED: set a real address (polite pool)
USER_AGENT = os.environ.get("EXTRACT_USER_AGENT") or f"vintage-data/0.1 (mailto:{MAILTO})"
